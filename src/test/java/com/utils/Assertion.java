...
public class Assertion {
	...
	/* Assertion added for checking text is visible on UI by Shubham Yadav */
	
	public boolean checkIfStringIsVisble(String Value) {
    	
    	Log.info("Trying to check if the given string is visible on UI");
