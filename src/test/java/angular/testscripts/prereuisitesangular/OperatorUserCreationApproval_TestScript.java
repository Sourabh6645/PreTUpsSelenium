...
import angular.feature.OperatorUserCreationAndApprovalFeature;

public class OperatorUserCreationApproval_TestScript extends BaseTest{
	
	@Test(dataProvider = "categoryData")
	//@TestManager(TestKey = "PRETUPS-000") // TO BE UNCOMMENTED WITH JIRA TEST CASE
	public void A_01_Test_SuperAdmin_ShouldBeAble_ToCreateUser_AndApprove(String userCat, String LoginId,
			String Password) {
		
		final String methodName = "A_01_Test_SuperAdmin_ShouldBeAble_ToCreateUser_AndApprove";
		...
		OperatorUserCreationAndApprovalFeature OpUserCreationApproval = new OperatorUserCreationAndApprovalFeature(driver);
		OpUserCreationApproval.performUserCreationAndApproval(LoginId, Password);
