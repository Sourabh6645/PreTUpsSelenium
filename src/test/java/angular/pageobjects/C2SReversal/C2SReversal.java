...
//		WebElement blankErrorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='invalid-feedback ng-star-inserted'])[1]//div")));
	...
	public void clickReversalRecharge() {
		...
		WebElement recharge = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/pretups-ui-demo/reversal']")));
		recharge.click();
	...
	public void clickProceedButton() {
		WebElement proceedButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(@class,'reset-btn')]//following::button//span")));
		proceedButton.click();
