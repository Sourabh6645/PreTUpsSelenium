...
public class C2CApproval {
	...
	public void clickC2CApprovalLevel1Heading() {
		...
		WebElement c2cApprovalLevel1Heading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/pretups-ui-demo/approvallevel/ap1']")));
	...
	public void clickC2CApprovalLevel2Heading() {
		...
		WebElement c2cApprovalLevel2Heading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/pretups-ui-demo/approvallevel/ap2']")));
	...
	public void clickC2CApprovalLevel3Heading() {
		...
		WebElement c2cApprovalLevel3Heading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/pretups-ui-demo/approvallevel/ap3']")));
	...
	public void clickC2CHeading() {
		...
		WebElement c2cHeading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='assets/images/c2c_icons/channel_to_channel_sidebar.svg']")));
		c2cHeading.click();
...
//		WebElement approve =  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id='reject']/preceding-sibling::button//span")));
		WebElement approve =  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),' APPROVE ')]")));
		approve.click();
		Log.info("User clicked Approve Button	.");
	}
	...
	public void confirmApproval() {
		...
		WebElement approve = driver.findElement(By.xpath("(//button[@id='reject']/preceding-sibling::button//span)[2]"));
		try {
			wait.until(ExpectedConditions.visibilityOf(approve));
		}catch(Exception e) {
			Log.info("Review and Confirm window is not visible, Trying again");
			approveSecondScreen();
		}
		
		approve.click();
		Log.info("User clicked Approve Button On Review and Confirm.");
	}
