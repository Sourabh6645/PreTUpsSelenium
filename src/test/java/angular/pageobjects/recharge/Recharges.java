...
//	/* ------------------ */
	...
	@FindBy(xpath = "//img[@src='assets/images/recharge_icons/recharge.svg']")
	private WebElement rechargeHeading;

	@FindBy(xpath = "//img[@src='assets/images/recharge_icons/recharge.svg']//following::span[contains(@class,'expand')]") //changed by Shubham
	private WebElement expanded;

	@FindBy(xpath = "//img[@src='assets/images/recharge_icons/recharge.svg']//following::a[1]")
	private WebElement recharge;

	@FindBy(xpath = "//img[@src='./assets/images/recharge_icons/PrepaidRecharge.svg']")
	...
	/*
	 * @FindBy(xpath =
	 * "//img[@src='./assets/images/recharge_icons/PostpaidBill.svg']") private
	 * WebElement postpaidrecharge;
	 */
	...
	/*
	 * @FindBy(xpath =
	 * "//app-recharge//a[@href='/pretups-ui/recharge/internetRecharge']") private
	 * WebElement internetrecharge;
	 */
...
//	private WebElement rechargeDone ;
	...
	public void EVDClickResertButton() {
		...
		WebElement transferStatus = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id='reset']")));
	...
	public void EVDClickTryAgain() {
		Log.info("Trying to Click Try again.");
		WebElement transferStatus = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id='anotherRecharge']")));
	...
	public String EVDRechargeStatus() {
		...
		WebElement transferStatus = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='modal-basic-title-fail']")));
//		WebElement transferStatus=driver.findElement(By.xpath("//div[@class='modal-content']//div[@class='recharge-successful']"));
	...
	public void clickRechargeDone() {
		...
		WebElement rechargeDone = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//button[contains(@id,'anotherRecharge')]//span")));
//		WebElement rechargeDone = driver.findElement(By.xpath("//button[contains(@id,'anotherRecharge')]//span"));
	...
	public void clicktryAgainForFailRecharges() {
		...
		WebElement tryAgainForFailRecharge = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//button[contains(@id,'anotherRecharge')]//span")));
...
//		wait.until(ExpectedConditions.visibilityOf(tryAgainForFailRecharge));
	...
	public String getInvalidTextMessage() {
		WebElement invalidPinTextMessage = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@id,'vals failuremsg')]")));
...
//	}
	...
	public String getAmount() {
		WebElement amount = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//form[@id='control']//input[@formcontrolname='amount']")));
//		WebElement amount= driver.findElement(By.xpath("//form[@id='control']//input[@formcontrolname='amount']"));
		...
		/*
		 * Boolean check = SubMsisdnInputField.matches("[A-Za-z]"); return check;
		 */
	...
	public boolean PINPopupVisibility() {
		...
		try {
			...
			WebElement closeEnterPINPopup = wait
					.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//button[@class='close']//img")));
//			WebElement closeEnterPINPopup = driver.findElement(By.xpath(".//button[@class='close']//img"));
	...
	public void clickCloseEnterPINPopup() {
		...
		closeEnterPINPopup = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@class='close']")));
	...
	public boolean RechargeIconVisibility() {
		...
		try {
			...
			WebElement rechargeIcon = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//div[@class='rowRight']//button[@id='recharge']")));
//			WebElement rechargeIcon=driver.findElement(By.xpath("//div[@class='rowRight']//button[@id='recharge']"));
	...
	public boolean GiftRechargeIconVisibility() {
		...
		try {
			Log.info("Waiting for RECHARGE Button after closing the Enter PIN Popup");
			WebElement rechargeGiftIcon = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//div[@class='rowRight']//button[@id='rechargeGift']")));
//			WebElement rechargeGiftIcon=driver.findElement(By.xpath("//div[@class='rowRight']//button[@id='rechargeGift']"));
	...
	public boolean checkRechargeButtonIsClickable() {
		...
		try {
			...
			WebElement rechargeButton = wait.until(ExpectedConditions.visibilityOfElementLocated(
					By.xpath("(//div[@class='modal-content']//div//button[@type='button'])[2]")));
//			WebElement rechargeButton = driver.findElement(By.xpath("(//div[@class='modal-content']//div//button[@type='button'])[2]"));
	...
	public boolean ContinueButtonAfterBlankPINVisibility() {
		...
		try {
			...
			WebElement continuePageAfterBlankPIN = wait
					.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@class='formyesBtn']")));
...
//		WebElement continuePageAfterBlankPIN =driver.findElement(By.xpath("//button[@class='formyesBtn']"));
	...
	public void clickResetButton() {
		...
		WebElement resetButton = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(@id, 'reset')]")));
//		WebElement resetButton =driver.findElement(By.xpath("//button[contains(@id, 'reset')]"));
	...
	public List<WebElement> C2SXFailedTransactionHeading() {
		List<WebElement> validationErrors = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
				By.xpath("//form[@id='control']//div[contains(@class,'ng-star-inserted')]")));
...
//		List<WebElement> validationErrors=driver.findElements(By.xpath("//form[@id='control']//div[contains(@class,'ng-star-inserted')]"));
	...
	public String getSubMSISDN() {
		WebElement subscriberMsisdn = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//form[@id='control']//input[@formcontrolname='msisdn']")));
//		WebElement subscriberMsisdn=driver.findElement(By.xpath("//form[@id='control']//input[@formcontrolname='msisdn']"));
	...
	public boolean failedPopUPVisibility() {
		boolean result = false;
		try {
			WebElement transferStatusFailed = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//div[contains(@id,'modal-basic-title-fail')]")));
...
//		WebElement transferStatusFailed=driver.findElement(By.xpath("//div[contains(@id,'modal-basic-title-fail')]"));
	...
	public void clickRechargeHeading() {
		// WebElement rechargeHeading
		// =wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//nav[@class='sidebar']//div[@class='nested-menu']//a[@id='rechargeMain']")));
//		WebElement rechargeHeading =driver.findElement(By.xpath("//nav[@class='sidebar']//div[@class='nested-menu']//a[@id='rechargeMain']"));
	...
	public boolean isRechargeVisibile() {
		try {
			// WebElement expanded =
			// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@id='rechargeMain']//span[@class='childmenucss1
			// expand']")));
			// WebElement recharge
			// =driver.findElement(By.xpath("//nav[@class='sidebar']//div[@class='nested-menu']//a[@id='recharge']"));
	...
	/*
	 * public void clickRechargeHeading() { String path =
	 * "//nav[@class='sidebar']//div[@class='nested-menu']//a[@id='rechargeMain']";
	 ...
	 * Log.info("User clicked Recharged Heading Link."); }
	 * 
	 * public void clickRechargeHeading() { String path = "rechargeMain"; WebElement
	...
	public void clickRecharge() {
		// WebElement recharge =
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//nav[@class='sidebar']//div[@class='nested-menu']//a[@id='recharge']")));
//		WebElement recharge =driver.findElement(By.xpath("//nav[@class='sidebar']//div[@class='nested-menu']//a[@id='recharge']"));
	...
	public void clickPrepaidRecharge() {
		// WebElement prepaidrecharge=
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//app-recharge//a[@href='/pretups-ui/recharge']")));
		// WebElement
		// prepaidrecharge=driver.findElement(By.xpath("//app-recharge//a[@href='/pretups-ui/recharge']"));
	...
	public void clickRechargeButton() {
		...
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='modal-content']//div//button[@type='button'])[2]")));
//		WebElement rechargeButton=driver.findElement(By.xpath("(//div[@class='modal-content']//div//button[@type='button'])[2]"));
	...
	public void clickRechargeIcon() {
		// WebElement rechargeIcon=
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='rowRight']//button[@id='recharge']")));
//		WebElement rechargeIcon=driver.findElement(By.xpath("//div[@class='rowRight']//button[@id='recharge']"));
		// wait.until(ExpectedConditions.visibilityOf(rechargeIcon));
		rechargeIcon.click();
		Log.info("User clicked Recharge button");
...
//		WebElement rechargeGiftIcon=driver.findElement(By.xpath("//div[@class='rowRight']//button[@id='rechargeGift']"));
	...
	public void giftRechargeCheckBox() {
		WebElement giftCheckBox = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//mat-checkbox[@id='checkbox1']")));
//		WebElement giftCheckBox=driver.findElement(By.xpath("//mat-checkbox[@id='checkbox1']"));
	...
	public void clickPostpaidRecharge() {
		WebElement postpaidrecharge = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//img[@src='./assets/images/recharge_icons/PostpaidBill.svg']")));
//		WebElement postpaidrecharge =driver.findElement(By.xpath("//img[@src='./assets/images/recharge_icons/PostpaidBill.svg']"));
	...
	public void clickInternetRecharge() {
		WebElement internetrecharge = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//img[@src='./assets/images/recharge_icons/Internet.svg']")));
//		WebElement internetrecharge=driver.findElement(By.xpath("//app-recharge//a[@href='/pretups-ui/recharge/internetRecharge']"));
	...
	public void clickFixlineRecharge() {
		WebElement fixlinerecharge = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//img[@src='./assets/images/recharge_icons/FixedLine.svg']")));
//		WebElement fixlinerecharge=driver.findElement(By.xpath("//app-recharge//a[@href='/pretups-ui/recharge/fixedLineRecharge']"));
	...
	public void clickDoneButton() {
		// WebElement donButton=
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id='done']")));
...
//		WebElement subscriberMsisdn=driver.findElement(By.xpath("//form[@id='control']//input[@formcontrolname='msisdn']"));
	...
	public void enterGifterMSISDN(String SubMSISDN) {
		WebElement gifterMsisdn = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//form[@id='control']//input[@formcontrolname='gifterMsisdn']")));
//		WebElement gifterMsisdn=driver.findElement(By.xpath("//form[@id='control']//input[@formcontrolname='gifterMsisdn']"));
	...
	public void enterGifterName(String name) {
		WebElement gifterName = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//form[@id='control']//input[@formcontrolname='gifterName']")));
//		WebElement gifterName=driver.findElement(By.xpath("//form[@id='control']//input[@formcontrolname='gifterName']"));
	...
	public void enterNotificationNumber(String SubMSISDN) {
		WebElement noticationMobileNumber = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//form[@id='control']//input[@formcontrolname='noticationMobileNum']")));
//		WebElement gifterName=driver.findElement(By.xpath("//form[@id='control']//input[@formcontrolname='noticationMobileNum']"));
	...
	public double getCurrentBalance() {
		...
		try {
			...
			/// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='maskWhite']//div[contains(@class,'balance')]")));
			...
			while (flag != true) {
				...
				if (!(balance == null || balance.equals(""))) {
					...
					/* Seprate all numbers only from given string -- Change by shubham */
					for (int j = 0; j < balance.length(); j++) {
						if (Character.isDigit(balance.charAt(j)))
							num.append(balance.charAt(j));
					}
					// x = Double.parseDouble(balance.replaceAll("\\p{Sc}|,", "")); ---- Earlier
					// x = Double.parseDouble(balance.replaceAll("\u20B9|,", ""));
					balance = num.toString();
					x = Double.parseDouble(balance);
					Log.info("Current Balance of user: " + num);
					flag = true;
			...
			WebElement currentBalance = wait.until(ExpectedConditions.visibilityOfElementLocated(
					By.xpath("//div[@class='maskWhite']//div[contains(@class,'balance')]")));
	...
	public void enterAmount(String Amount) {
		// WebElement amount =
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//form[@id='control']//input[@formcontrolname='amount']")));
//		WebElement amount=driver.findElement(By.xpath("//form[@id='control']//input[@formcontrolname='amount']"));
		// wait.until(ExpectedConditions.visibilityOf(amount));
		Log.info("Inside Enter Amount" + Amount);
		amount.clear();
	...
	public void selectSubService(String SubService) {
		try {
			...
			// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//ng-select[@formcontrolname='subService']")));
//			WebElement subService=driver.findElement(By.xpath("//ng-select[@formcontrolname='subService']"));
			...
			WebElement subServiceDropdown = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
					"//ng-select[@formcontrolname='subService']//ng-dropdown-panel[contains(@class,'ng-star-inserted')]")));
//			WebElement subServiceDropdown=driver.findElement(By.xpath("//ng-select[@formcontrolname='subService']//ng-dropdown-panel[contains(@class,'ng-star-inserted')]"));
			...
			String subServices = String.format(
					"//ng-select[@formcontrolname='subService']//ng-dropdown-panel[contains(@class,'ng-star-inserted')]//span[text()='%s']",
					SubService);
			driver.findElement(By.xpath(subServices)).click();
			Log.info("SubService selected successfully as: " + SubService);
		} catch (Exception e) {
			Log.debug("<b>SubService Selector Not Found:</b>");
		}
	}
	...
	public void enterPin(String ChnUsrPin) {
		...
		// WebElement enterYourPin=
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='modal-content']//input[@formcontrolname='pin']")));
//		WebElement enterYourPin=driver.findElement(By.xpath("//div[@class='modal-content']//input[@formcontrolname='pin']"));
	...
	public boolean successPopUPVisibility() {
		...
		try {
			...
			// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='recharge-successful']")));
//			WebElement successPopUP=driver.findElement(By.xpath("//div[@class='modal-content']//div[@class='success']"));
	...
	public String transferID() {
		...
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='modal-content']//div[@id='vals
		// txnidsuccess']")));
//		WebElement transferID=driver.findElement(By.xpath("//div[@class='modal-content']//div[@id='vals txnidsuccess']"));
	...
	public String transferStatus() {
		...
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='modal-content']//div[@class='recharge-successful']")));
//		WebElement transferStatus=driver.findElement(By.xpath("//div[@class='modal-content']//div[@class='recharge-successful']"));
		// wait.until(ExpectedConditions.visibilityOf(transferStatus));
		String trfStatus = transferStatus.getText();
		Log.info("Transfer status fetched as : " + trfStatus);
...
//		WebElement subscriberMsisdn=driver.findElement(By.xpath("//form[@id='control']//input[@formcontrolname='msisdn']"));
	...
	public void clickCopyButton() {
		...
		WebElement copyButton = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(@id, 'copy')]")));
//		WebElement copyButton =driver.findElement(By.xpath("//button[contains(@id, 'copy')]"));
	...
	public void clickPrintButton() {
		...
		WebElement printButton = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(@id, 'print')]")));
...
//		WebElement gifterName= driver.findElement(By.xpath("//form[@id='control']//input[@formcontrolname='gifterName']"));
	 ...
	 * 
	 * public String getDate() throws InterruptedException { String[] dateTime=
	 * loginDateAndTime.getText().split(" ");
	 * System.out.println(loginDateAndTime.getText()); System.out.println(dateTime);
	 * String date = dateTime[11]; System.out.println(date);
	 * Log.info("Server date: "+date); return date; }
	 * 
	 * public void clickC2CTransfer() {
	 * Log.info("Trying to click Channel to Channel link."); c2cTransfer.click();
	 ...
	 * Log.info("Trying to click Withdrawal link"); c2cWithdraw.click();
	 ...
	 * Log.info("Trying to click O2C Transfer link"); o2cTransfer.click();
	 * Log.info("O2C Transfer link clicked successfully"); }
	 * 
	 * public boolean C2STransferLinkVisibility(){
	 * Log.info("Trying to check C2S Transfer Link exists"); boolean result = false;
	 * try { if (c2sTransfer.isDisplayed()) { Log.info("C2S Transfer Link exists");
	 * result = true; } } catch (NoSuchElementException e) { result = false;
	 * Log.info("C2S Transfer Link does not exist"); } return result; }
	 * 
	 * 
	 * public boolean C2CTransferLinkVisibility(){
	 * 
	 * Log.info("Trying to check C2C Transfer Link exists"); boolean result = false;
	 * try { if (c2cTransfer.isDisplayed()) { Log.info("C2C Transfer Link exists");
	 * result = true; } } catch (NoSuchElementException e) { result = false;
	 * Log.info("C2C Transfer Link does not exist"); } return result;
	 * 
	 * }
	 * 
