...
public class RechargesBulk {
    ...
    public void clickRecharge() {
        ...
        WebElement recharge = new WebDriverWait(driver,20).until(ExpectedConditions.elementToBeClickable(By.xpath("//img[@src='assets/images/recharge_icons/recharge.svg']")));
    ...
    public void clickBulkPrepaidRecharge() {
        ...
        WebElement BulkPrepaidRecharge= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/pretups-ui-demo/recharge/bulkRecharge']//span")));
    ...
    public void clickBulkInternetRecharge() {
        ...
        WebElement BulkInternetRecharge= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='./assets/images/internetBulk/png/ib.png']")));//div//a[@href='/pretups-ui/recharge/bulkInternet'
...
*/
    public void uploadFile(String filePath) {
        try {
            ...
            driver.findElement(By.xpath("//div[contains(@class,'clickarea')]//label[@class='company-copy']")).click();
