...
public class O2CTransferApproval {
    ...
    public O2CTransferApproval(WebDriver driver) {
      ...
      public void clickOPTO2CHeading() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/approvallevelo2c/ap1']")));
    ...
    public void clickCUO2CHeading() {
        ...
        WebElement o2cTransactionHeading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='assets/images/o2c_icons/operatortochannel.svg']")));
        /*((JavascriptExecutor) driver).executeScript("arguments[0].click();", o2cTransactionHeading);*/
        try {
            o2cTransactionHeading.click();
        }
    ...
    public boolean isO2CApproval1Visible() {
        ...
        try {
            WebElement expanded = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[@href='/approvallevelo2c/ap1'])[2]")));
            if(expanded.isDisplayed()) {
                Log.info("Element is expanded");
                return true;
            }
    ...
    public boolean isO2CApproval2Visible() {
        try {
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/approvallevelo2c/ap2']")));
        }
        catch(Exception e){
            e.printStackTrace();
        }
    ...
    public boolean isO2CApproval3Visible() {
        try {
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/approvallevelo2c/ap3']")));
        }
        catch(Exception e){
            e.printStackTrace();
        }
    ...
    public void selectPaymentMode(String PaymentMode) {
        try {
            Log.info("Trying to select Payment Mode");
            WebElement paymentmodedropdown = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id = 'ng-select-box-payment-default']//span[contains(@class,'ng-arrow-wrapper')]"))); //Changed by Shubham Yadav
            paymentmodedropdown.click();
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id = 'ng-select-box-payment-default']//ng-dropdown-panel")));
    ...
    public void selectDatefromDatePicker() {
    	...
    	WebElement datepicker = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(@class,'ui-calendar-button')]")));
    	datepicker.click();
    	Log.info("Clicked on Date Picker");
    	Log.info("Selecting Date from Date Picker");
    	WebElement currentdate = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(@class,'ui-state-highlight')]")));
    	currentdate.click();
    	Log.info("Selected current date");
    }

    public void approvalExtDateCU() {
		Log.info("Trying to select Date Ext Transaction Date");
		
		WebElement datepicker = driver.findElement(By.xpath("(//button[contains(@class,'ui-calendar-button')])[1]"));
		datepicker.click();
		WebElement currentDate = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(@class,'ui-state-highlight')]")));
		currentDate.click();
		Log.info("Selected Date Ext Transaction Date");
    ...
    public void selectEternalTxnDate(String Date)
    {
        Log.info("Trying to enter Approval Date..");
        WebElement enterApprvDate = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@type='text'])[3]")));
        enterApprvDate.sendKeys(Date);
    ...
    public String geteTopupAmountError()
    {
        ...
        WebElement remarksError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//label[text() = 'eTopUP']/parent::div/following-sibling::div//div//following-sibling::div)[1]")));
    ...
    public String getPosteTopUpAmountError()
    {
        ...
        WebElement remarksError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//label[text() = 'Post eTopUP']/parent::div/following-sibling::div//div//following-sibling::div)[1]")));
        String RemarksErrorMessage = remarksError.getText();
        return RemarksErrorMessage;
    }
    ...
    public String getAmountError()
    {
        ...
        WebElement amountError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='amoutnInput']//following::div[contains(@class,'invalid-feedback')]//div)[1]")));
    ...
    public void clickApproval1O2CHeading() {
        ...
        WebElement apprv1Heading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='assets/images/home/svg/home.svg']//following::a[1]")));
    ...
    public void clickApproval2O2CHeading() {
        ...
        WebElement apprv2Heading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='assets/images/home/svg/home.svg']//following::a[5]")));
    ...
    public void clickApproval3O2CHeading() {
        try {
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='assets/images/home/svg/home.svg']//following::a[9]")));
        }
        catch(Exception e){
            e.printStackTrace();
        }
        Log.info("Trying clicking on Approval 3 O2C Heading");
        WebElement apprv3Heading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='assets/images/home/svg/home.svg']//following::a[9]")));
    ...
    public void clickApproval1Transaction() {
        ...
        WebElement apprv1txnHeading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//img[@src='assets/images/home/svg/home.svg']//following::a)[1]//following::a[1]")));
    ...
    public void clickApproval2Transaction() {
        ...
        WebElement apprv2txnHeading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//img[@src='assets/images/home/svg/home.svg']//following::a)[5]//following::a[1]")));
    ...
    public void clickApproval3Transaction() {
        ...
        WebElement apprv3txnHeading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//img[@src='assets/images/home/svg/home.svg']//following::a)[9]//following::a[1]")));
    ...
    // New Addition by shubham yadav
    public void OptoChApprovalusingMobileNumber(String msisdn) {
    	
    	Log.info("Trying to enter MSISDN..");
    	WebElement msisdnInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='name']")));
    	msisdnInput.sendKeys(msisdn);
    	
    	Log.info("Trying to clikc on proceed button");
    	WebElement proceedButton = driver.findElement(By.xpath("//button[@name='Proceed']//span"));
    	proceedButton.click();
    ...
    public void OpToChProceedwithApproval() {
    	
    	Log.info("Proceeding with approval procedure");
    	WebElement proceedApproval = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//table[@id='parentTable']//tbody//td[15]//span)[1]")));
    	proceedApproval.click();
    	Log.info("Proceeding with approval procedure Success");    
    ...
    public void confirmApproval() {
		Log.info("Trying to Click the second approval button");
		WebElement approve =  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//button[@id='reject']//preceding-sibling::button//span)[2]")));
		approve.click();
		Log.info("User clicked second approval Button.");
	}
