...
public class CommissionProfile_TestScript extends BaseTest {
	...
	public void A_01_Test_CommissionProfile_UserIsAbleTO_Add_Modify_Delete_NewCommissionProfile(String UserCat, String LoginId,
		...
		CommissionProfile_Feature cpf = new CommissionProfile_Feature(driver);

		cpf.Add_Modify_UpdateStatus_Delete_CommissionProfile(LoginId, Password);
	...
	// @TestManager(TestKey = "PRETUPS-000") // TO BE UNCOMMENTED WITH JIRA TEST
	// CASE
	public void A_02_Test_CommissionProfile_UserIsAbleTO_Modify_CommissionProfile_FromActionPane(String UserCat, String LoginId,
			String Password) {
		final String methodName = "A_02_Test_CommissionProfile_UserIsAbleTO_Modify_CommissionProfile_FromActionPane";
		Log.startTestCase(methodName, UserCat, LoginId, Password);
		CaseMaster CaseMaster = _masterVO.getCaseMasterByID("PreTUPSCommissionProfile02");
		currentNode = test.createNode(MessageFormat.format(CaseMaster.getExtentCase(), UserCat))
				.assignCategory(TestCategory.PREREQUISITE);

		CommissionProfile_Feature cpf = new CommissionProfile_Feature(driver);

		cpf.Modify_CommissionProfile_FromActionPane(LoginId, Password);
	...
	// @TestManager(TestKey = "PRETUPS-000") // TO BE UNCOMMENTED WITH JIRA TEST
	// CASE
	public void A_03_Test_CommissionProfile_UserIsUnableTO_Update_CommissionProfile_OfDefault(String UserCat, String LoginId,
			String Password) {
		final String methodName = "A_03_Test_CommissionProfile_UserIsUnableTO_Update_CommissionProfile_OfDefault";
		Log.startTestCase(methodName, UserCat, LoginId, Password);
		CaseMaster CaseMaster = _masterVO.getCaseMasterByID("PreTUPSCommissionProfile03");
		currentNode = test.createNode(MessageFormat.format(CaseMaster.getExtentCase(), UserCat))
				.assignCategory(TestCategory.PREREQUISITE);

		CommissionProfile_Feature cpf = new CommissionProfile_Feature(driver);

		cpf.UnableToChangeStatus_Of_Default_CommissionProfile(LoginId, Password);
	...
	// @TestManager(TestKey = "PRETUPS-000") // TO BE UNCOMMENTED WITH JIRA TEST
	// CASE
	public void A_04_Test_CommissionProfile__CommissionProfile_ViewDetails_LandingPage(String UserCat, String LoginId,
			String Password) {
		final String methodName = "A_04_Test_CommissionProfile__CommissionProfile_ViewDetails_LandingPage";
		Log.startTestCase(methodName, UserCat, LoginId, Password);
		CaseMaster CaseMaster = _masterVO.getCaseMasterByID("PreTUPSCommissionProfile04");
		currentNode = test.createNode(MessageFormat.format(CaseMaster.getExtentCase(), UserCat))
				.assignCategory(TestCategory.PREREQUISITE);

		CommissionProfile_Feature cpf = new CommissionProfile_Feature(driver);

		cpf.CommissionProfile_LandingPage_ViewDetails(LoginId, Password);
