...
public class AccessManagementChannelUser {
    ...
    public void clickChannelUserHeading() {
        ...
        WebElement ChannelUserHeading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@id='channelusername_header']")));
        try {
    ...
    public void clickAccessManagement(){
        ...
        WebElement vwMreBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//table[contains(@class,'DTFC_Cloned')])[4]//span[2]//img[@alt='password']")));
    ...
    public String getLoginID(){
        ...
        String fetchedLoginID = loginID.getAttribute("innerText");
        Log.info("Fetched Login ID of Child User :" + fetchedLoginID);
        return fetchedLoginID;
    }
    
    public boolean checkLoginIdVisibilty(String LoginId) {
    	Assertion a = new Assertion();
    	Log.info("Trying to check if Login ID is Visible On UI");
    	
    	if(a.checkIfStringIsVisble(LoginId)) {
    		Log.info("String is Visible On Screen");
    		return true;
    ...
    public void clickViewMore(){
        ...
        WebElement vwMreBtn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@class = 'filterbtn']//following::span[contains(@class,'childmenucss')]")));
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", vwMreBtn);
