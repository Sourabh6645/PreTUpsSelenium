...
//	private WebElement C2CBuypaymentInstDate;
	...
	@FindBy(xpath = "//a[@href='/pretups-ui-demo/channeltochannel/buy']")
...
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='dateId']")));
	...
	public void enterC2CBuyPaymentInstDate() {
		Log.info("Trying to enter Payment Instrument Date");
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//primeng-datepicker[@id='paymentDatePicker']/span/input")));
//		C2CBuypaymentInstDate.sendKeys(PaymentInstDate);   ---- Commented by Shubham Yadav
		
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(@class,'ui-calendar-button')]"))).click();
...
//					productBalanceCommaRemoved =  productBalanceCommaRemoved.replace("₹","") ;
	...
	public HashMap<String,String> enterQuantityforC2CWithdrawlRevamp(HashMap<String,String> qty){
		...
		for(int countQty=1; countQty <= Qty.size(); countQty++){
			WebElement qtyField = driver.findElement(By.xpath("(//input[@id='amoutnId'])[" +countQty+ "]")) ;
			String productShortCode = driver.findElement(By.xpath("(//label[contains(@class,'company')])["+countQty+"]")).getText();
			ExcelUtility.setExcelFile(_masterVO.getProperty("DataProvider"), ExcelI.PRODUCT_SHEET);
			int rowCount = ExcelUtility.getRowCount();
			Log.info("rowCount of c2c topups available on screen : "+rowCount) ;
			for (int i = 1; i <= rowCount; i++) {
	...
	public void clickSingleBuyHeading() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/pretups-ui-demo/channeltochannel/buy']")));
		c2cSingleBuy.click();
	...
	public void clickSingleWithdrawalHeading() {
		...
		WebElement c2cSingleWithdrawal=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='./assets/images/c2c_icons/withdrawal.svg']")));
	...
	public void clickSingleReturnHeading() {
		...
		WebElement c2cSingleWithdrawal=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='./assets/images/c2c_icons/return.svg']")));
		c2cSingleWithdrawal.click();
	...
	public boolean isC2CVisible() {
		try {
			WebElement expanded = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@src='assets/images/c2c_icons/channel_to_channel_sidebar.svg']//following::span[contains(@class,'expand')]")));
...
/*	public void selectProduct(String Product) {
	...
	public void clickC2CTransactionHeading() {
		...
		WebElement c2cTransactionHeading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[@href='/pretups-ui-demo/channeltochannel'])[2]")));
	...
	public void clickC2CHeading() {
		...
		WebElement c2cHeading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/pretups-ui-demo/recharge']/following-sibling::a[@href='/pretups-ui-demo/channeltochannel']")));
		c2cHeading.click();
