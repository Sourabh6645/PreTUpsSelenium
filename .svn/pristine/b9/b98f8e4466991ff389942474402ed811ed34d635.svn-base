...
public class C2CTransferRevamp extends BaseTest {
	...
	public HashMap<String, String> performC2CTransferMobileBuyerType(String FromCategory, String ToCategory,
			String toMSISDN, String PIN, String catCode, String fromParent) {
...
//        transfers.enterPaymentInstDate(s.format(d));
			...
			if (PINPopUP == true) {
				...
				boolean C2CTransferInitiatedPopup = transfers.C2CTransferInitiatedVisibility(); // Transfer initiated
																								// displays etopup
																								// ptopup
				if (C2CTransferInitiatedPopup == true) {
					...
					if (actualMessage.equals(C2CTransferResultMessage)) {
						...
						ExtentI.Markup(ExtentColor.RED,
								"C2C Transfer Initiated Displays wrong message as " + C2CTransferResultMessage);
						ExtentI.attachCatalinaLogs();
						ExtentI.attachScreenShot();
					}
				} else {
	...
	public HashMap<String, String> performC2CTransferLoginBuyerType(String FromCategory, String ToCategory,
			String toMSISDN, String PIN, String catCode, String fromParent) {
...
//        transfers.enterPaymentInstDate(transfers.getDateMMDDYYYY());
	...
	public HashMap<String, String> performC2CTransferUsernameBuyerType(String FromCategory, String ToCategory,
			String toMSISDN, String PIN, String catCode, String fromParent) {
		final String methodname = "performC2CTransfer";
		Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
...
//        transfers.enterPaymentInstDate(transfers.getDateMMDDYYYY());
	...
	public void performC2CTransferBlankBuyerType(String FromCategory, String ToCategory, String toMSISDN, String PIN,
			String catCode) {
	...
	public void performC2CTransferBlankMSISDNofMobileBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
	...
	public void performC2CTransferBlankTOPUPSofMobileBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
	...
	public void performC2CTransferBlankCategoryOfUsernameBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
		final String methodname = "performC2CTransferBlankMSISDN";
		Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
		...
		Log.info("Function returned - Blank Category Error message fetched from GUI : "
				+ blankCategoryErrorMessageCaptured);
	...
	public void performC2CTransferBlankUsernameOfUsernameBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
		final String methodname = "performC2CTransferBlankMSISDN";
		Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
		...
		Log.info("Function returned - Blank Username Error message fetched from GUI : "
				+ blankUsernameErrorMessageCaptured);
		String expectedMessage = "User Category is required";
	...
	public void performC2CTransferBlankCategoryOfLOGINIDBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
		final String methodname = "performC2CTransferBlankMSISDN";
		Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
	...
	public void performC2CTransferBlankLoginidOfLOGINIDBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
		final String methodname = "performC2CTransferBlankMSISDN";
		Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
		...
		Log.info("Function returned - Blank Loginid Error message fetched from GUI : "
				+ blankLoginidErrorMessageCaptured);
	...
	public void performC2CTransferNegativeAmountOfMobileBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
...
//        }
			...
			Log.info("Function returned - Negative Amount Error message fetched from GUI : "
					+ negativeAmountErrorMessageCaptured);
	...
	public void performC2CTrfSplAmtOfMobileBuyer(String FromCategory, String ToCategory, String toMSISDN, String PIN,
			String catCode) {
...
//        }
			...
			Log.info("Function returned - Special Character in Amount Error message fetched from GUI : "
					+ splCharAmtErrorMessageCaptured);
			String expectedMessage = "QTY is not numeric.";
			if (expectedMessage.contains(splCharAmtErrorMessageCaptured)) {
				...
				currentNode.log(Status.FAIL,
						"Special Character in Amount of Mobile Buyer type Error did not display on GUI");
				ExtentI.attachCatalinaLogs();
				ExtentI.attachScreenShot();
			}
			Log.methodExit(methodname);
	...
	public void performC2CTransferBlankAmountOfMobileBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
...
//        transfers.enterPaymentInstDate(transfers.getDateMMDDYYYY());
			...
			Log.info("Function returned - Blank Amount Error message fetched from GUI : "
					+ blankAmountErrorMessageCaptured);
			String expectedMessage = "Amount is required.";
	...
	public void performC2CTransferInvalidRefNoOfMobileBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
...
//        transfers.enterPaymentInstDate(transfers.getDateMMDDYYYY());
		...
		Log.info("Function returned - Invalid RefNo Error message fetched from GUI : "
				+ InvalidRefNoErrorMessageCaptured);
	...
	public void performC2CTransferSplCharRefNo(String FromCategory, String ToCategory, String toMSISDN, String PIN,
			String catCode) {
...
//        transfers.enterPaymentInstDate(transfers.getDateMMDDYYYY());
			...
			Log.info("Function returned - Invalid RefNo Error message fetched from GUI : "
					+ splCharRefNoErrorMessageCaptured);
			...
			if (expectedMessage.contains(splCharRefNoErrorMessageCaptured)) {
				...
				currentNode.log(Status.FAIL,
						"Special Characters in Reference number of Mobile Buyer type Error did not display on GUI");
				ExtentI.attachCatalinaLogs();
				ExtentI.attachScreenShot();
			}
			Log.methodExit(methodname);
	...
	public void performC2CTransferBlankRemarksOfMobileBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
...
//        transfers.enterPaymentInstDate(transfers.getDateMMDDYYYY());
		...
		Log.info("Function returned - Blank Remarks Error message fetched from GUI : "
				+ blankRemarksErrorMessageCaptured);
	...
	public void performC2CTransferBlankPaymentModeOfMobileBuyer(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
...
//        transfers.enterPaymentInstDate(transfers.getDateMMDDYYYY());
			...
			Log.info("Function returned - Blank PaymentModes Error message fetched from GUI : "
					+ blankPaymentModesErrorMessageCaptured);
	...
	public void performC2CTransferInvalidPinMobileBuyerType(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode) {
...
//        transfers.enterPaymentInstDate(transfers.getDateMMDDYYYY());
			...
			if (PINPopUP == true) {
				...
				transfers.clickC2CTransferSubmitButtonAfterEnteringPIN();
				boolean C2CTransferInitiatedPopup = transfers.C2CTransferFailedVisibility(); // Transfer initiated
																								// displays etopup
																								// ptopup
				if (C2CTransferInitiatedPopup == true) {
					...
					if (actualMessage.equals(C2CTransferResultMessage)) {
						...
						Assertion.assertContainsEquals(C2CTransferResultMessage, actualMessage);
						ExtentI.Markup(ExtentColor.RED,
								"C2C Transfer Failed Displays wrong message as " + C2CTransferResultMessage);
						ExtentI.attachCatalinaLogs();
						ExtentI.attachScreenShot();
					}
				} else {
...
//		}
	...
	public void invalidRefNoApprovalLevel(String FromCategory, String ToCategory, String PIN, String txndId,
			int maxApprovalLevel, String fromParent) {
		final String methodname = "performC2CTransferMobileBuyerType";
	...
	public void rejectInApprovalLevel(String FromCategory, String ToCategory, String PIN, String txndId,
			int maxApprovalLevel, String fromParent) {
	...
	public HashMap<String, String> performC2CWithdrawalMobileBuyerType(String FromCategory, String ToCategory,
			String toMSISDN, String PIN, String catCode, String fromParent, HashMap<String, String> qty) {
		...
		if (PINPopUP == true) {
			...
			boolean C2CTransferInitiatedPopup = transfers.C2CWithdrawlVisibility(); // Transfer initiated displays
																					// etopup ptopup
			if (C2CTransferInitiatedPopup == true) {
				...
				if (actualMessage.equals(C2CWithdrawlResultMessage)) {
					...
					ExtentI.Markup(ExtentColor.RED,
							"C2C Transfer Initiated Displays wrong message as " + C2CWithdrawlResultMessage);
					ExtentI.attachCatalinaLogs();
					ExtentI.attachScreenShot();
				}
			} else {
	...
	public HashMap<String, String> performC2CWithdrawalLoginBuyerType(String FromCategory, String ToCategory,
			String toMSISDN, String PIN, String catCode, String fromParent, HashMap<String, String> qty) {
		final String methodname = "performC2CWithdrawalMobileBuyerType";
		Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
	...
	public HashMap<String, String> performC2CWithdrawalUsernameBuyerType(String FromCategory, String ToCategory,
			String toMSISDN, String PIN, String catCode, String fromParent, HashMap<String, String> qty) {
		final String methodname = "performC2CWithdrawalMobileBuyerType";
		Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
	...
	public void performC2CWithdrawalMobileBuyerType_InvalidAmount(String FromCategory, String ToCategory,
			String toMSISDN, String PIN, String catCode, String fromParent) {
		int value = -100;
		final String methodname = "performC2CWithdrawalMobileBuyerType";
		Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN);
	...
	public void performC2CWithdrawalMobileBuyerType_BlankAmount(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode, String fromParent) {
	...
	public void performC2CWithdrawalMobileBuyerType_BlankRemarks(String FromCategory, String ToCategory,
			String toMSISDN, String PIN, String catCode, String fromParent) {
		final String methodname = "performC2CWithdrawalMobileBuyerType";
		Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
	...
	public void performC2CWithdrawalMobileBuyerType_InvalidPin(String FromCategory, String ToCategory, String toMSISDN,
			String PIN, String catCode, String fromParent) {
		...
		if (PINPopUP == true) {
			...
			if (C2CTransferInitiatedPopup == true) {
				...
				if (actualMessage.equals(InvalidPinMessage)) {
					...
					Assertion.assertContainsEquals(InvalidPinMessage, actualMessage);
					ExtentI.Markup(ExtentColor.RED,
							"C2C Withdrawl Failed Displays wrong message as " + InvalidPinMessage);
					ExtentI.attachCatalinaLogs();
					ExtentI.attachScreenShot();
				}
			} else {
...
//    }
	...
	/*
	 * 
	 * public void performC2CTransferBlankBatchName(String FromCategory, String
	 * ToCategory, String toMSISDN, String PIN, String catCode) { final String
	 * methodname = "C2CTransferBlankBatchName"; Log.methodEntry(methodname,
	 * FromCategory, ToCategory, toMSISDN, PIN); String MasterSheetPath =
	 * _masterVO.getProperty("DataProvider");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); login.UserLogin(driver, "ChannelUser",
	 * FromCategory); if(!transfers.isC2CVisible()) {
	 * transfers.clickC2CTransactionHeading();
	 * Log.info("C2C Transfer heading is clicked"); } else {
	 * transfers.clickC2CHeading(); transfers.clickC2CTransactionHeading();
	 * Log.info("C2C Heading and Transaction Heading is clicked"); }
	 * transfers.clickC2CBulkOperationHeading();
	 * transfers.clickBulkTransferHeading(); transfers.selectCategory(ToCategory);
	 * transfers.clickSubmitButtonC2CTransfer(); String errorMessageCaptured =
	 * transfers.batchNameErrorMessages(); String expectedMessage =
	 * "Batch Name is required"; boolean flag = false; if
	 * (expectedMessage.equals(errorMessageCaptured)) { flag = true;
	 * Assertion.assertContainsEquals(errorMessageCaptured, expectedMessage);
	 * ExtentI.attachCatalinaLogsForSuccess(); } else { currentNode.log(Status.FAIL,
	 * "Blank Batch Name not displayed on GUI"); ExtentI.attachCatalinaLogs();
	 * ExtentI.attachScreenShot(); } Log.methodExit(methodname); }
	 * 
	 * 
	 * public void performC2CTransferWithoutUpload(String FromCategory, String
	 * ToCategory, String toMSISDN, String PIN, String catCode) { final String
	 * methodname = "C2CTransferWithoutUpload"; Log.methodEntry(methodname,
	 * FromCategory, ToCategory, toMSISDN, PIN); String MasterSheetPath =
	 * _masterVO.getProperty("DataProvider");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); login.UserLogin(driver, "ChannelUser",
	 * FromCategory); RandomGeneration RandomGeneration = new RandomGeneration();
	 * if(!transfers.isC2CVisible()) { transfers.clickC2CTransactionHeading();
	 * Log.info("C2C Transfer heading is clicked"); } else {
	 * transfers.clickC2CHeading(); transfers.clickC2CTransactionHeading();
	 * Log.info("C2C Heading and Transaction Heading is clicked"); }
	 * transfers.clickC2CBulkOperationHeading();
	 ...
	 * transfers.clickSubmitButtonC2CTransfer() ; List<WebElement>
	 * errorMessageCaptured = transfers.validationErrorsOnGUI() ; String
	 * actualMessage = null; String expectedMessage = "File is required" ; boolean
	 * flag = false; for (WebElement ele : errorMessageCaptured) { actualMessage =
	 * ele.getText(); if (expectedMessage.equals(actualMessage)) { flag = true;
	 * break; } } if (flag) { Assertion.assertContainsEquals(actualMessage,
	 * expectedMessage); ExtentI.attachCatalinaLogsForSuccess();
	 * ExtentI.attachScreenShot(); } else { currentNode.log(Status.FAIL,
	 * "C2C is successful without uploading file"); ExtentI.attachCatalinaLogs();
	 * ExtentI.attachScreenShot(); } Log.methodExit(methodname) ; }
	 * 
	 * 
	 * public void performC2CTransferResetButton(String FromCategory, String
	 * ToCategory, String toMSISDN, String PIN, String catCode) { final String
	 * methodname = "performC2CTransferResetButton"; Log.methodEntry(methodname,
	 * FromCategory, ToCategory, toMSISDN, PIN); String MasterSheetPath =
	 * _masterVO.getProperty("DataProvider");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); login.UserLogin(driver, "ChannelUser",
	 ...
	 * transfers.enterBatchName("AUTBN" + RandomGeneration.randomNumeric(5));
	 * transfers.clickResetButton(); transfers.clickSubmitButtonC2CTransfer();
	 * 
	 * Boolean blankCategory = transfers.getblankCategory(); String blankBatchName =
	 * transfers.getblankBatchName();
	 * 
	 * Boolean checkBatchName = blankBatchName.equals("");
	 * if(!blankCategory&&checkBatchName) { ExtentI.Markup(ExtentColor.GREEN,
	 * "All fields are blank hence Reset button click successful");
	 * ExtentI.attachCatalinaLogsForSuccess(); } else{ currentNode.log(Status.FAIL,
	 * "Fields are not blank hence Reset button failed.");
	 * ExtentI.attachCatalinaLogs(); ExtentI.attachScreenShot(); }
	 * Log.methodExit(methodname) ; }
	 * 
	 * 
	 * public void performC2CTransferDownloadUserListWithoutCategory(String
	 * FromCategory, String ToCategory, String toMSISDN, String PIN, String catCode)
	 * { final String methodname = "C2CTransferDownloadUserListWithoutCategory";
	 * Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN); String
	 ...
	 * Log.info("C2C Heading and Transaction Heading is clicked"); }
	 * transfers.clickC2CBulkOperationHeading();
	 * transfers.clickBulkTransferHeading(); transfers.clickDownloadUserListIcon() ;
	 * List<WebElement> errorMessageCaptured = transfers.validationErrorsOnGUI() ;
	 * String actualMessage = null; String expectedMessage =
	 * "User Category is required." ; boolean flag = false; for (WebElement ele :
	 * errorMessageCaptured) { actualMessage = ele.getText(); if
	 * (expectedMessage.equals(actualMessage)) { flag = true; break; } } if (flag) {
	 * Assertion.assertContainsEquals(actualMessage, expectedMessage);
	 * ExtentI.Markup(ExtentColor.GREEN,
	 * "User List Downloaded Failed Without Category");
	 * ExtentI.attachCatalinaLogsForSuccess(); } else {
	 ...
	 * 
	 * 
	 * public void performC2CTransferDownloadTemplateWithoutCategory(String
	 * FromCategory, String ToCategory, String toMSISDN, String PIN, String catCode)
	 ...
	 * Log.info("C2C Heading and Transaction Heading is clicked"); }
	 * transfers.clickC2CBulkOperationHeading();
	 * transfers.clickBulkTransferHeading(); String downloadDirPath =
	 * _masterVO.getProperty("C2CTransferPath") ; int NoOfFilesBefore =
	 * transfers.noOfFilesInDownloadedDirectory(downloadDirPath) ;
	 * 
	 * transfers.clickDownloadBlankUserTemplateIcon();
	 * 
	 * int NoOfFilesAfter =
	 ...
	 * 
	 * 
	 * public void performC2CTransferFileUploadType(String FromCategory, String
	 * ToCategory, String toMSISDN, String PIN, String catCode) throws
	 * InterruptedException { final String methodname = "C2CTransferFileUploadType";
	 * Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN); String
	 * MasterSheetPath = _masterVO.getProperty("DataProvider"); String PNGPath =
	 * System.getProperty("user.dir")+_masterVO.getProperty("PNGFile");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); login.UserLogin(driver, "ChannelUser",
	 * FromCategory); RandomGeneration RandomGeneration = new RandomGeneration();
	 * if(!transfers.isC2CVisible()) { transfers.clickC2CTransactionHeading();
	 ...
	 * 
	 * String errorMessageCaptured = transfers.fileUploadTypeErrorMessage(); String
	 * expectedMessage = "Only CSV,XLS & XLSX Files are allowed"; if
	 * (expectedMessage.equals(errorMessageCaptured)) {
	 * Assertion.assertContainsEquals(errorMessageCaptured, expectedMessage);
	 * ExtentI.attachCatalinaLogsForSuccess(); } else { currentNode.log(Status.FAIL,
	 * "File Uploaded is not of type CSV,XLS or XLSX");
	 * ExtentI.attachCatalinaLogs(); ExtentI.attachScreenShot(); }
	 * Log.methodExit(methodname) ; }
	 * 
	 * 
	 * public void performC2CTransferBlankPIN(String FromCategory, String
	 * ToCategory, String toMSISDN, String PIN, String catCode) { final String
	 * methodname = "performC2CTransferBlankPIN"; Log.methodEntry(methodname,
	 * FromCategory, ToCategory, toMSISDN, PIN); String MasterSheetPath =
	 * _masterVO.getProperty("DataProvider");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); login.UserLogin(driver, "ChannelUser",
	 ...
	 * System.getProperty("user.dir")+_masterVO.getProperty("C2CTransferUpload") +
	 * latestFileName ; transfers.uploadFile(uploadFileName);
	 * transfers.clickSubmitButtonC2CTransfer(); transfers.enterC2CPIN("") ;
	 * //Boolean confirmButtonVisible = transfers.clickPINSubmitButton() ; Boolean
	 * confirmButtonDisabled = transfers.clickPINSubmitButton() ;
	 * if(confirmButtonDisabled) { ExtentI.Markup(ExtentColor.GREEN,
	 * "Confirm PIN button is disabled for blank pin");
	 * ExtentI.attachCatalinaLogsForSuccess(); } else{
	 * ExtentI.Markup(ExtentColor.RED,
	 * "C2C PIN Confirm Button is not disabled successfully with blank pin");
	 * ExtentI.attachCatalinaLogs(); ExtentI.attachScreenShot(); }
	 * Log.methodExit(methodname) ; }
	 * 
	 * public void performC2CTransferBlankFileUpload(String FromCategory, String
	 * ToCategory, String toMSISDN, String PIN, String catCode) { final String
	 * methodname = "performC2CTransferBlankPIN"; Log.methodEntry(methodname,
	 * FromCategory, ToCategory, toMSISDN, PIN); String MasterSheetPath =
	 * _masterVO.getProperty("DataProvider");
	 ...
	 * transfers.clickC2CBulkOperationHeading();
	 * transfers.clickBulkTransferHeading(); transfers.selectCategory(ToCategory);
	 * transfers.clickDownloadUserListIcon(); transfers.enterBatchName("AUTBN" +
	 * RandomGeneration.randomNumeric(5));
	 * 
	 * 
	 * int noOfFiles = transfers.noOfFilesInDownloadedDirectory(PathOfFile) ;
	 * 
	 * if(noOfFiles > 0) { // Log.info("\n\n\n\nFILES IN DIR = " + noOfFiles) ;
	 ...
	 * String uploadPath =
	 * System.getProperty("user.dir")+_masterVO.getProperty("C2CTransferUpload") +
	 * latestFileName ; //System.out.println("\n\n\n\n UPLOAD PATH --- "+uploadPath)
	 * ; transfers.uploadFile(uploadPath);
	 * 
	 * transfers.clickSubmitButtonC2CTransfer();
	 * 
	 * transfers.enterC2CPIN(PIN) ; transfers.clickPINSubmitButton() ; String
	 * C2CFailMessagePopup = transfers.checkC2CFailMessage() ;
	 * Log.info("C2CFailMessagePopup : " + C2CFailMessagePopup);
	 * 
	 * if (C2CFailMessagePopup.toUpperCase().contains("FAIL")) { String
	 * reasonForFail = transfers.getErrorMessageForFailure(); String actualMessage =
	 * "The number of errors in the file exceed the maximum number allowed"; if
	 * (reasonForFail.equals(actualMessage)) {
	 * Assertion.assertContainsEquals(reasonForFail, actualMessage);
	 * ExtentI.Markup(ExtentColor.GREEN, "C2C with Blank Excel Failed for reason : "
	 * + reasonForFail); ExtentI.attachCatalinaLogsForSuccess(); } else {
	 * currentNode.log(Status.FAIL, "Invalid message given.");
	 * ExtentI.Markup(ExtentColor.RED, "Invalid message displayed on GUI : " +
	 * reasonForFail); ExtentI.attachCatalinaLogs(); ExtentI.attachScreenShot(); } }
	 * else { currentNode.log(Status.FAIL, "C2C IS Successful with Blank Excel.");
	 * ExtentI.attachCatalinaLogs(); ExtentI.attachScreenShot(); }
	 * 
	 * Log.methodExit(methodname) ; }
	 * 
	 * 
	 * public void performC2CTransferInvalidMSISDN(String FromCategory, String
	 * ToCategory, String toMSISDN, String PIN, String catCode) { final String
	 * methodname = "performC2CTransferInvalidMSISDN"; Log.methodEntry(methodname,
	 * FromCategory, ToCategory, toMSISDN, PIN); String MasterSheetPath =
	 * _masterVO.getProperty("DataProvider");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); login.UserLogin(driver, "ChannelUser",
	 ...
	 * if(!transfers.isC2CVisible()) { transfers.clickC2CTransactionHeading();
	 * Log.info("C2C Transaction heading is clicked"); } else {
	 * transfers.clickC2CHeading(); transfers.clickC2CTransactionHeading();
	 * Log.info("C2C Heading and Transaction Heading is clicked"); }
	 * transfers.clickC2CBulkOperationHeading();
	 * transfers.clickBulkTransferHeading(); transfers.selectCategory(ToCategory);
	 ...
	 * 
	 * transfers.enterBatchName("AUTBN" + RandomGeneration.randomNumeric(5)); String
	 * MSISDN2 = RandomGeneration.randomNumeric(12);
	 ...
	 * ExcelUtility.setCellDataXLS("ETOPUP",1,4); Log.info("Written to Excel : " +
	 * MSISDN2 + ", " + "03, ETOPUP");
	 * 
	 * 
	 * String uploadPath =
	 * System.getProperty("user.dir")+_masterVO.getProperty("C2CTransferUpload") +
	 * latestFileName ; transfers.uploadFile(uploadPath);
	 * transfers.clickSubmitButtonC2CTransfer(); transfers.enterPin(PIN);
	 * transfers.clickPINConfirmButton() ;
	 * 
	 * String failReason = "No such user exists, MSISDN is invalid.";
	 * 
	 * 
	 * boolean successPopUP = transfers.successPopUPVisibility(); if (successPopUP
	 * == true) { actualMessage = transfers.C2CFailReason();
	 * 
	 * if (actualMessage.contains(failReason)) { ExtentI.Markup(ExtentColor.GREEN,
	 * "C2C Bulk Transfer Transaction fails due to invalid MSISDN, error message Found as: "
	 * + actualMessage); ExtentI.attachCatalinaLogsForSuccess(); } else {
	 * currentNode.log(Status.FAIL,
	 * "Error message due to invalid MSISDN not shown. Transfer message on WEB: " +
	 * actualMessage); ExtentI.attachCatalinaLogs(); ExtentI.attachScreenShot(); }
	 * 
	 * } else { currentNode.log(Status.FAIL,
	 * "Error message due to invalid MSISDN not shown. Transfer message on WEB: " +
	 * actualMessage); ExtentI.attachCatalinaLogs(); ExtentI.attachScreenShot(); }
	 * 
	 * Log.methodExit(methodname) ; }
	 ...
	 * 
	 * 
	 * public void performC2CTransferInvalidHeaderFileUpload(String FromCategory,
	 * String ToCategory, String toMSISDN, String PIN, String catCode) { final
	 * String methodname = "performC2CTransferInvaliDataFileUpload";
	 * Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN); String
	 * MasterSheetPath = _masterVO.getProperty("DataProvider");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); login.UserLogin(driver, "ChannelUser",
	 ...
	 * 
	 * String FilePathAndName = PathOfFile + latestFileName ;
	 * ExcelUtility.setExcelFileXLS(FilePathAndName, ExcelI.SHEET1) ; for(int j = 0;
	 * j<ExcelUtility.getColumnCount() ; j++) {
	 ...
	 * Log.info("C2CFailMessagePopup : " + C2CFailMessagePopup);
	 * 
	 * String actualMessage = "Invalid column header given." ; if
	 * (C2CFailMessagePopup.toUpperCase().contains("FAIL")) { String reasonForFail =
	 * transfers.getErrorMessageForFailure() ;
	 * if(reasonForFail.equals(actualMessage)) {
	 * Assertion.assertContainsEquals(reasonForFail, actualMessage);
	 * ExtentI.Markup(ExtentColor.GREEN,
	 * "C2C Failed with Invalid header, error on GUI : "+reasonForFail);
	 * ExtentI.attachCatalinaLogsForSuccess(); } else {
	 * Assertion.assertContainsEquals(reasonForFail, actualMessage);
	 * ExtentI.Markup(ExtentColor.RED,
	 * "Invalid message displayed on GUI : "+reasonForFail);
	 * ExtentI.attachCatalinaLogs(); ExtentI.attachScreenShot(); } } else {
	 ...
	 * 
	 * 
	 * public void performC2CTransferInvalidDataFileUpload(String FromCategory,
	 * String ToCategory, String toMSISDN, String PIN, String catCode) { final
	 * String methodname = "performC2CTransferInvaliDataFileUpload";
	 * Log.methodEntry(methodname, FromCategory, ToCategory, toMSISDN, PIN); String
	 * MasterSheetPath = _masterVO.getProperty("DataProvider");
	 ...
	 * 
	 * if(noOfFiles > 0) { // Log.info("\n\n\n\nFILES IN DIR = " + noOfFiles) ;
	 * ExcelUtility.deleteFiles(PathOfFile) ; } else {
	 * ExcelUtility.createBlankExcelFile(PathOfFile+"C2CTransfer.xls") ;
	 * Log.info("User template download Failed, Created an Empty Excel File") ; }
	 * transfers.clickDownloadBlankUserTemplateIcon() ;
	 * 
	 ...
	 * 
	 * String FilePathAndName = PathOfFile + latestFileName ;
	 * ExcelUtility.setExcelFileXLS(FilePathAndName, ExcelI.SHEET1) ; for(int i = 1;
	 * i<=2; i++) { for(int j=0; j < ExcelUtility.getColumnCount() ; j++ ) {
	 ...
	 * transfers.enterC2CPIN(PIN) ; transfers.clickPINSubmitButton() ; String
	 * C2CFailMessagePopup = transfers.checkC2CFailMessage() ;
	 * Log.info("C2CFailMessagePopup : " + C2CFailMessagePopup); if
	 * (C2CFailMessagePopup.toUpperCase().contains("FAIL")) { String reasonForFail =
	 * transfers.getErrorMessageForFailure() ; String actualMessage =
	 * "ALL records contain error.Kindly check logs." ;
	 * if(reasonForFail.equals(actualMessage)) {
	 * Assertion.assertContainsEquals(reasonForFail, actualMessage);
	 * ExtentI.Markup(ExtentColor.GREEN,
	 * "C2C with Blank Excel Failed for reason : "+reasonForFail);
	 * ExtentI.attachCatalinaLogsForSuccess(); } else {
	 * Assertion.assertContainsEquals(reasonForFail, actualMessage);
	 * ExtentI.Markup(ExtentColor.RED,
	 * "Invalid message displayed on GUI : "+reasonForFail);
	 ...
	 * Log.methodExit(methodname) ; }
	 * 
	 * public void performC2CTransferBlankDataFileWithHeaderUpload(String
	 * FromCategory, String ToCategory, String toMSISDN, String PIN, String catCode)
	 ...
	 * int noOfFiles = transfers.noOfFilesInDownloadedDirectory(PathOfFile) ;
	 * 
	 * if(noOfFiles > 0) { ExcelUtility.deleteFiles(PathOfFile) ; }
	 * transfers.clickDownloadBlankUserTemplateIcon() ;
	 * 
	 * String latestFileName = transfers.getLatestFileNamefromDir(PathOfFile) ;
	 * 
	 ...
	 * transfers.enterC2CPIN(PIN) ; transfers.clickPINSubmitButton() ; String
	 * C2CFailMessagePopup = transfers.checkC2CFailMessage() ;
	 * Log.info("C2CFailMessagePopup : " + C2CFailMessagePopup); String
	 * actualMessage = "No record available." ; if
	 * (C2CFailMessagePopup.toUpperCase().contains("FAIL")) { String reasonForFail =
	 * transfers.getErrorMessageForFailure() ;
	 * if(reasonForFail.equals(actualMessage)) {
	 * Assertion.assertContainsEquals(reasonForFail, actualMessage);
	 * ExtentI.Markup(ExtentColor.GREEN,
	 * "C2C Failed with Blank data, error on GUI : "+reasonForFail);
	 * ExtentI.attachCatalinaLogsForSuccess(); } else {
	 * Assertion.assertContainsEquals(reasonForFail, actualMessage);
	 * ExtentI.Markup(ExtentColor.RED,
	 * "Invalid message displayed on GUI : "+reasonForFail);
	 ...
	 * 
	 * 
	 * public void performC2CTransferSymbolBatchName(String FromCategory, String
	 * ToCategory, String toMSISDN, String PIN, String catCode) { final String
	 * methodname = "C2CTransferSymbolBatchName"; Log.methodEntry(methodname,
	 * FromCategory, ToCategory, toMSISDN, PIN); String MasterSheetPath =
	 * _masterVO.getProperty("DataProvider");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); login.UserLogin(driver, "ChannelUser",
	 ...
	 * if(!transfers.isC2CVisible()) { transfers.clickC2CTransactionHeading();
	 * 
	 * } else { transfers.clickC2CHeading(); transfers.clickC2CTransactionHeading();
	 * 
	 * } transfers.clickC2CBulkOperationHeading();
	 * transfers.clickBulkTransferHeading(); transfers.selectCategory(FromCategory);
	 * transfers.clickDownloadUserListIcon(); transfers.isFileDownloaded();
	 * transfers.clickDownloadBlankUserTemplateIcon();
	 * transfers.enterBatchName("%$#@^&"); transfers.clickSubmitButtonC2CTransfer();
	 * String errorMessageCaptured = transfers.batchNameErrorMessages(); String
	 * expectedMessage = "Batch Name is invalid"; if
	 * (expectedMessage.equals(errorMessageCaptured)) {
	 * Assertion.assertContainsEquals(errorMessageCaptured, expectedMessage);
	 * ExtentI.attachCatalinaLogsForSuccess(); } else { currentNode.log(Status.FAIL,
	 * "Batch name entered is Invalid or Symbolic"); ExtentI.attachCatalinaLogs();
	 * ExtentI.attachScreenShot(); } Log.methodExit(methodname) ; }
	 * 
	 * 
	 * 
	 ...
	 * 
	 * 
	 * public void performC2CTransferBlankProduct(String FromCategory, String
	 * ToCategory, String toMSISDN, String PIN, String catCode) { final String
	 * methodname = "C2CTransferBlankProduct"; Log.methodEntry(methodname,
	 * FromCategory, ToCategory, toMSISDN, PIN); String MasterSheetPath =
	 * _masterVO.getProperty("DataProvider");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); login.UserLogin(driver, "ChannelUser",
	 * FromCategory); transfers.clickC2CHeading();
	 * transfers.clickC2CTransactionHeading();
	 * transfers.clickC2CBulkOperationHeading();
	 * transfers.clickBulkTransferHeading(); String errorMessageCaptured =
	 * transfers.blankCategoryMessages(); Log.info("errorMessageCaptured : " +
	 * errorMessageCaptured); String expectedMessage = "Product is required."; if
	 * (expectedMessage.equals(errorMessageCaptured)) {
	 * Assertion.assertContainsEquals(errorMessageCaptured, expectedMessage);
	 * ExtentI.attachCatalinaLogsForSuccess(); } else { currentNode.log(Status.FAIL,
	 * "Blank Category Error not displayed on GUI"); ExtentI.attachCatalinaLogs();
	 * ExtentI.attachScreenShot(); } Log.methodExit(methodname) ; }
	 * 
	 * 
	 * 
	...
	/*
	 * CHECK DATE FORMAT public void performC2CTransferMobileBuyerType(String
	 * FromCategory, String ToCategory, String toMSISDN, String PIN, String catCode)
	 * { final String methodname = "performC2CTransfer"; Log.methodEntry(methodname,
	 * FromCategory, ToCategory, toMSISDN, PIN); String MasterSheetPath =
	 * _masterVO.getProperty("DataProvider");
	 * ExcelUtility.setExcelFile(MasterSheetPath,
	 * ExcelI.CHANNEL_USERS_HIERARCHY_SHEET); String loginID =
	 * login.getUserLoginID(driver, "ChannelUser", FromCategory);
	 * Log.info("LOGINID : "+loginID ) ; login.UserLogin(driver, "ChannelUser",
	 * FromCategory); RandomGeneration RandomGeneration = new RandomGeneration();
	 * String transferID = null, transferStatus = null, trf_status = null;
	 * 
	 * if (!transfers.isC2CVisible()) { transfers.clickC2CTransactionHeading();
	 ...
	 * Log.info("C2C Heading and Transaction Heading is clicked"); }
	 * transfers.clickC2CSingleOperationHeading();
	 * transfers.clickSingleTransferHeading(); transfers.clickEtopup();
	 * 
	 * transfers.selectC2CBuyerType(_masterVO.getProperty("C2CMobileBuyerType")) ;
	 * transfers.enterC2CMsisdn(toMSISDN); transfers.clickC2CProceed();
	 * transfers.enterQuantityforC2CRevamp() ; RandomGeneration randomGeneration =
	 * new RandomGeneration();
	 * transfers.enterRefNum(randomGeneration.randomNumeric(6));
	 * transfers.enterRemarks("Remarks entered for C2C to: " + ToCategory +
	 * " User : " + toMSISDN) ;
	 * transfers.selectPaymentMode(_masterVO.getProperty("C2CPaymentModeType"));
	 * transfers.enterPaymentInstNum(_masterVO.getProperty("PaymentInstNum"));
	 * String dateFormatInDB =
	 * DBHandler.AccessHandler.getSystemPreference(ExcelI.DATE_FORMAT_CAL_JAVA) ;
	 * 
	 * String dateOnGUI = transfers.getDateOnGUI() ; Boolean dateFormatsEqual =
	 * transfers.checkDateFormats(dateFormatInDB, dateOnGUI) ; if(dateFormatsEqual)
	 * { Log.info("Date Formats in DB are same") ;
	 * transfers.enterPaymentInstDate(transfers.getDateMMDDYY());
	 * transfers.clickC2CTransferSubmitButton();
	 * 
	 * boolean PINPopUP = transfers.C2CEnterPINPopupVisibility(); //enter User PIN
	 * for C2C if (PINPopUP == true) { transfers.enterC2CUserPIN(PIN);
	 * transfers.clickC2CTransferSubmitButtonAfterEnteringPIN(); boolean
	 * C2CTransferInitiatedPopup = transfers.C2CTransferInitiatedVisibility();
	 * //Transfer initiated displays etopup ptopup if (C2CTransferInitiatedPopup ==
	 * true) { String actualMessage = "Transfer Request Initiated"; String
	 * C2CTransferResultMessage =
	 * transfers.getC2CTransferTransferRequestInitiatedMessage(); if
	 * (actualMessage.equals(C2CTransferResultMessage)) {
	 * transfers.printC2CTopupsInitiatedAmounts(); ExtentI.Markup(ExtentColor.GREEN,
	 * "C2C Transfer Initiated : " + C2CTransferResultMessage);
	 * transfers.printC2CTransferTransactionID();
	 * ExtentI.attachCatalinaLogsForSuccess() ;
	 * transfers.clickC2CTransferRequestDoneButton(); } else {
	 * ExtentI.Markup(ExtentColor.RED,
	 * "C2C Transfer Initiated Displays wrong message as " +
	 * C2CTransferResultMessage); ExtentI.attachCatalinaLogs();
	 * ExtentI.attachScreenShot(); } } else { String errorMEssageForFailure =
	 * transfers.getErrorMessageForFailure(); ExtentI.Markup(ExtentColor.RED,
	 * "C2C Transfer Initiated Failed"); ExtentI.attachCatalinaLogs();
	 * ExtentI.attachScreenShot(); } } else { ExtentI.Markup(ExtentColor.RED,
	 * "Enter PIN Popup for C2C didnt display"); ExtentI.attachCatalinaLogs();
	 * ExtentI.attachScreenShot(); } }else { ExtentI.Markup(ExtentColor.RED,
	 * "DATE FORMAT INCORRECT on GUI"); ExtentI.attachCatalinaLogs();
	 * ExtentI.attachScreenShot(); }
	 * 
	 * Log.methodExit(methodname); }
	 * 
