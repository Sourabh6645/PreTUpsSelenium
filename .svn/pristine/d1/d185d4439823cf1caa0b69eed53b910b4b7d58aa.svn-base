...
public interface DBInterface {
	...
	/* Query Interface for Voucher Expiry
	 * Author - Shubham Yadav
	 */
	
	//public List<Integer> getVoucherList();
	
	public int getC2STransferRuleDeleteCount();
	public String getPreferenceModificationStatus(String fieldName);
	/* Author Shubham Yadav  */
	public List<String> getMultipleVoucherSerialNumber(String vouchCat,String voStat,String productId,int count);
